...
/* Prints the files and directories recursively in the directory tree.
 *  Param1 is the node
 * Param2 is the recursion level
 */
...
/* Creates the files and directories recursively in the directory tree.
 *  Param1 is the node
 * Param2 is the path
 */
